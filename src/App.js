        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Shelf books={books.filter(b => b.category === 'Currently Reading')} category="Currently Reading"/>
                <Shelf books={books.filter(b => b.category === 'Want to Read')} category="Want to Read"/>
                <Shelf books={books.filter(b => b.category === 'Read')} category="Read"/>
              </div>
            </div>
